About symengine-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/symengine-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/symengine-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/symengine-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1983&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/symengine-feedstock?branchName=main">
          </a>
        </summary>
        <table>
...
It is possible to list all of the versions of `symengine` available on your platform:
...
```
mamba search symengine --channel conda-forge
```
...
```
pixi search symengine --channel conda-forge
```
...
mamba repoquery search symengine --channel conda-forge

# List packages depending on `symengine`:
mamba repoquery whoneeds symengine --channel conda-forge

# List dependencies of `symengine`:
mamba repoquery depends symengine --channel conda-forge
```
